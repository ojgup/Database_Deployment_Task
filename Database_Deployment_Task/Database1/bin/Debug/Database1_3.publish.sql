...
GO
ALTER TABLE [dbo].[Student] DROP CONSTRAINT [FK__Student__AUTHORI__2C00EBAB];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Author])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Author] ([AUTHORID], [AUTHORTAXFILENUMBER], [AUTHORLASTNAME], [AUTHORFIRSTNAME])
        SELECT   [AUTHORID],
                 [AUTHORTAXFILENUMBER],
                 [AUTHORLASTNAME],
                 [AUTHORFIRSTNAME]
